...
building_name = "modern_office_tower"
colours = ["black", "white", "brown1", "brown2", "midgrey", "red_brown", "mauve", "grey"]
levels = ["L"]
variants = {
    "a" : {
		"xoffset" : "2",
...
for i in variants:
	...
	with open(r'./variants/' + variant_names[n] +'.pnml', 'r') as file:
		...
		data = data.replace(search_text_grnd, str('_' + grnd + '_'))
...
if random_switches_required == True:
	...
	print("No " + building_name + " random switches Required")
